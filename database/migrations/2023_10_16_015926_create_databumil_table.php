...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('databumil', function (Blueprint $table) {
            ...
            $table->float('bbawal', 6, 2);
            $table->integer('umur');
            $table->integer('umur_kehamilan');
            $table->string('jenis_persalinan', 1);
            $table->string('no_telepon_istri', 15);
            $table->date('htp');
            $table->string('jenisristi', 1);
            $table->tinyInteger('g');
            $table->tinyInteger('p');
            $table->tinyInteger('a');
            $table->float('lila', 6, 2);
            $table->smallInteger('sistole_akhir');
            $table->float('diastole_akhir', 6);
            $table->float('hb_akhir', 6, 2);
            $table->string('rt', 3);
            $table->string('rw', 3);
            $table->date('tanggal_melahirkan');
            $table->string('penolong', 15);
            $table->string('cara_lahir', 15);
            $table->string('kondisi_bayi', 9);
            $table->string('kondisi_ibu', 9);
            $table->tinyInteger('konseling_pasca_salin');
            $table->string('jenis_gakin', 1);
