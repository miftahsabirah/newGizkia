...
class PeriksabumilFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'keluhan' => substr($this->faker->sentence(6), 0, 50),
            'lila' => $this->faker->randomFloat(2, 1, 10),
            'sistole' => $this->faker->numberBetween(80, 120), 
            ...
            'tindakan_fe' => $this->faker->numberBetween(0, 1),
            'fe1' => $this->faker->numberBetween(0, 1),
            'fe2' => $this->faker->numberBetween(0, 1),
            'fe3' => $this->faker->numberBetween(0, 1),
            'tindakan_tt' => $this->faker->numberBetween(0, 1),
            'tt1' => $this->faker->numberBetween(0, 1),
            'tt2' => $this->faker->numberBetween(0, 1),
            'tt3' => $this->faker->numberBetween(0, 1),
            'dirujuk' => $this->faker->numberBetween(0, 1),
            'posisitbj' => $this->faker->randomElement(['A', 'B', 'C']),
            'tbj' => $this->faker->randomFloat(2, 20, 40),
            'kodefe' => substr($this->faker->word, 0, 2),
