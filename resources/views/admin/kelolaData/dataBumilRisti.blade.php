                ...
                <tbody>
                    @foreach ($databumilList as $item)
                        <tr>
                            ...
                            <td>{{ $item->htp }}</td>
                            <td>
                                <input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor1 }}"
                                    {{ $item->jenisfaktor->faktor1 ? 'checked' : '' }}>
                            </td>
                            <td><input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor2 }}"
                                    {{ $item->jenisfaktor->faktor2 ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor3 }}"
                                    {{ $item->jenisfaktor->faktor3 ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor4 }}"
                                    {{ $item->jenisfaktor->faktor4 ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor5 }}"
                                    {{ $item->jenisfaktor->faktor5 ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="faktor1" value="{{ $item->jenisfaktor->faktor6 }}"
                                    {{ $item->jenisfaktor->faktor6 ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->jantung }}"
                                    {{ $item->jenispenyakit->jantung ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->diabetes }}"
                                    {{ $item->jenispenyakit->diabetes ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->paru_paru }}"
                                    {{ $item->jenispenyakit->paru_paru ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->ginjal }}"
                                    {{ $item->jenispenyakit->ginjal ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->hati }}"
                                    {{ $item->jenispenyakit->hati ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->kurang_darah }}"
                                    {{ $item->jenispenyakit->kurang_darah ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->malaria }}"
                                    {{ $item->jenispenyakit->malaria ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->asma }}"
                                    {{ $item->jenispenyakit->asma ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->tbc }}"
                                    {{ $item->jenispenyakit->tbc ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->epilepsi }}"
                                    {{ $item->jenispenyakit->epilepsi ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->jiwa }}"
                                    {{ $item->jenispenyakit->jiwa ? 'checked' : '' }}></td>
                            <td><input type="checkbox" name="resiko1" value="{{ $item->jenispenyakit->pms }}"
