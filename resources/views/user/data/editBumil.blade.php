...
<h3 class="title-editform">Edit Data Bumil</h3>
...
<div id="container" class="container mt-4">
    ...
    <div class="step-container d-flex justify-content-between" style="width:70%; margin-left: auto; margin-right: auto;">
        ...
        <div class="step-circle" onclick="displayStep(2)" id="step-2">2. Alamat Ibu</div>  
    </div>
      ...
      <div class="step step-1">
        ...
        <h4>Data Diri </h4>
            <div class="formbold-input-flex">
                ...
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> BB Awal </label>
            ...
            <div class="formbold-input-flex">
                ...
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> Umur Hamil </label>
                    <input type="date" name="..." id="..." class="formbold-form-input" />
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                ...
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> Umur Kehamilan Sekarang</label>
                    <input type="text" name="..." id="..." class="formbold-form-input" />
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label">Tgl Reg</label>
                    <input type="date" name="..." id="..."
                        class="formbold-form-input" />
                </div>

                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> No Telp </label>
                    <input type="text" name="..." id="..." class="formbold-form-input" />
                </div>
            </div>
      ...
      <div class="step step-2">
        ...
        <h4>Alamat Ibu</h4>
            <div class="formbold-input-flex">
                ...
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> Puskesmas </label>
                    <input type="text" name="..." id="..." class="formbold-form-input" />
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                ...
                <div class="formbold-w-45">
                    <label for="..." class="formbold-form-label"> Kecamatan </label>
                    <input type="text" name="..." id="..." class="formbold-form-input" />
                </div>
            </div>
