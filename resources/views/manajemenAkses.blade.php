  ...
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <div class="flex items-center justify-between p-4 bg-white">
      ...
      <div class="relative">
        ...
        <input type="text" id="table-search-users" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-40 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari">
      </div>
    </div>
          ...
          <tr class="bg-F7F6FE border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4 flex items-center justify-between">
              <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline mx-2">
                <i class="fi fi-rr-square-x" style="font-size: 20px; color: #A11A1A;"></i>
              </a>
              <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline mx-2">
                <i class="fi fi-rr-checkbox" style="font-size: 20px; color: #307F4A;"></i>
              </a>
            </td>
          </tr>
